...
<div class="dropdown">
  ...
  <ul class="dropdown-menu w-100">
    ...
    <li><a class="dropdown-item" href="<?php echo e(route('education.index')); ?>"><i class="bi bi-book me-2"></i>EDUCATION</a></li>
        ...
        <a href="<?php echo e(route('master.list')); ?>" class="sidebar-btn text-decoration-none"><i class="bi bi-list-ul me-2"></i>Master List</a>
        <a href="<?php echo e(route('salary.adjustment')); ?>" class="sidebar-btn text-decoration-none"><i class="bi bi-calculator me-2"></i>Salary Adjustment/Differential</a>
      </nav>
    </aside>
      ...
      <div class="topbar d-flex align-items-center justify-content-between">
        ...
        <div class="d-flex align-items-center">
          <div class="user-welcome">
            <h6 class="mb-0 text-muted">Welcome back, <span class="user-name"><?php echo e(session('user_name')); ?></span></h6>
          </div>
        </div>
        ...
        <div class="d-none d-md-flex align-items-center gap-2 ms-auto">
          ...
          <a href="<?php echo e(url('/logout')); ?>" id="logoutBtn" class="logout-icon ms-2" title="Log out">
        ...
        <div class="collapse d-md-none w-100 mt-2" id="mobileTopbarMenu">
          <div class="d-flex flex-column gap-2 align-items-stretch">
            <div class="user-welcome mb-2 text-center">
              <small class="text-muted">Welcome back, <strong class="user-name"><?php echo e($userName ?? 'Guest'); ?></strong>!</small>
            </div>
            <div class="search-container" style="width:260px;">
            <div class="input-group">
              <span class="input-group-text bg-white"><i class="bi bi-search"></i></span>
            ...
            <a href="<?php echo e(url('/logout')); ?>" id="logoutBtnMobile" class="btn btn-outline-danger w-100" title="Log out">
          ...
          <div class="col-lg-2 col-md-4 col-sm-6">
            <div class="card-soft p-3 stat-card">
              <div class="d-flex align-items-center">
                ...
                <div>
                  <div class="stat-value" style="color: #28a745;"><?php echo e($totalFulltimeInstructors ?? 0); ?></div>
          ...
          <div class="col-lg-2 col-md-4 col-sm-6">
            <div class="card-soft p-3 stat-card">
              <div class="d-flex align-items-center">
                ...
                <div>
                  <div class="stat-value" style="color: #0734ff;"><?php echo e($totalParttimeInstructors ?? 0); ?></div>
          ...
          <div class="col-lg-2 col-md-4 col-sm-6">
            <div class="card-soft p-3 stat-card">
              <div class="d-flex align-items-center">
                ...
                <div>
                  <div class="stat-value" style="color: #dc3545;"><?php echo e($totalStaff ?? 0); ?></div>
          ...
          <div class="col-lg-2 col-md-4 col-sm-6">
            <div class="card-soft p-3 stat-card">
              <div class="d-flex align-items-center">
                ...
                <div>
                  <div class="stat-value" style="color: #6f42c1;"><?php echo e($totalUtility ?? 0); ?></div>
      ...
      <footer class="footer">
        <div class="footer-content">
          ...
          <div class="footer-bottom">
            <p>&copy; <?php echo e(date('Y')); ?> MCC Payroll System. All rights reserved. | Developed with <i class="bi bi-heart-fill text-danger"></i> for Madridejos Community College</p>
          </div>
        </div>
      </footer>
    </div>
  ...
  if (searchInput && searchDropdown) {
    searchInput.addEventListener('input', function() {
      ...
      searchTimeout = setTimeout(() => {
        fetch(`<?php echo e(route('search')); ?>?query=${encodeURIComponent(query)}`)
...
<?php /**PATH C:\xampp\htdocs\Mcc_Payroll\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>