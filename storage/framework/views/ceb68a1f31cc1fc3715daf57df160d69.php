...
<body>
  <div class="main-content">
    ...
    <form action="<?php echo e(route('fulltime.update', $timesheet->id)); ?>" method="POST">
      <?php echo csrf_field(); ?>
      <?php echo method_field('PUT'); ?>
      
      <div class="mb-3">
        <label for="employee_name" class="form-label">Employee Name</label>
        <input type="text" class="form-control" id="employee_name" name="employee_name" value="<?php echo e($timesheet->employee_name); ?>" required>
      </div>

      <div class="mb-3">
        <label for="email" class="form-label">Email</label>
        <input type="email" class="form-control" id="email" name="email" value="<?php echo e($timesheet->email); ?>" placeholder="name@gmail.com">
      </div>
      ...
      <div class="mb-3">
        ...
        <select class="form-control" id="designation" name="designation" required>
          ...
          <option value="instructor" <?php echo e($timesheet->designation == 'instructor' ? 'selected' : ''); ?>>Instructor</option>
          <option value="utility" <?php echo e($timesheet->designation == 'utility' ? 'selected' : ''); ?>>Utility</option>
          <option value="staff" <?php echo e($timesheet->designation == 'staff' ? 'selected' : ''); ?>>Staff</option>
        </select>
      </div>

      <div class="mb-3">
        <label for="prov_abr" class="form-label">Province Abbreviation</label>
        <input type="text" class="form-control" id="prov_abr" name="prov_abr" value="<?php echo e($timesheet->prov_abr); ?>">
      </div>
      ...
      <div class="mb-3">
        ...
        <select class="form-control" id="department" name="department">
          ...
          <?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $department): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <option value="<?php echo e($department->code); ?>" <?php echo e($timesheet->department == $department->code ? 'selected' : ''); ?>>
      ...
      <div class="mb-3">
            ...
            <?php for($i = 1; $i <= 15; $i++): ?>
              <div class="col-md-3 col-sm-4 col-6 mb-2">
                <div class="form-check">
                  <input class="form-check-input day-checkbox" type="checkbox" value="<?php echo e($i); ?>" id="day<?php echo e($i); ?>" <?php echo e(in_array($i, $selectedDays) ? 'checked' : ''); ?>>
                  <label class="form-check-label" for="day<?php echo e($i); ?>">
                    Day <?php echo e($i); ?>
        ...
        <input type="hidden" class="form-control" id="days" name="days" value="<?php echo e(is_array($timesheet->days) ? implode(',', $timesheet->days) : $timesheet->days); ?>">
      ...
      <div class="mb-3">
        ...
        <textarea class="form-control" id="details" name="details" rows="3"><?php echo e($timesheet->details); ?></textarea>
      </div>
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="mb-3">
            ...
            <input type="number" step="0.01" class="form-control" id="total_hour" name="total_hour" value="<?php echo e($timesheet->total_hour); ?>">
          </div>
        </div>
        <div class="col-md-6">
          <div class="mb-3">
            <label for="rate_per_hour" class="form-label">Rate per Hour</label>
            <input type="number" step="0.01" class="form-control" id="rate_per_hour" name="rate_per_hour" value="<?php echo e($timesheet->rate_per_hour); ?>">
          </div>
        </div>
      </div>
      ...
      <div class="mb-3">
        ...
        <input type="number" step="0.01" class="form-control" id="deduction" name="deduction" value="<?php echo e($timesheet->deduction); ?>">
      </div>

      <!-- Total Honorarium Display -->
      <div class="total-display">
        <p class="label">Calculated Total Honorarium</p>
        <p class="amount" id="calculated-total">₱<?php echo e(number_format($timesheet->total_honorarium, 2)); ?></p>
      </div>
      
      <input type="hidden" id="total_honorarium" name="total_honorarium" value="<?php echo e($timesheet->total_honorarium); ?>">

      <div class="button-group">
        <button type="submit" class="btn btn-primary">
          <i class="bi bi-check-lg me-1"></i>Update Timesheet
        </button>
        <a href="<?php echo e(route('fulltime.index')); ?>" class="btn btn-secondary">
...
<?php /**PATH C:\xampp\htdocs\Mcc_Payroll\resources\views/fulltime/edit.blade.php ENDPATH**/ ?>