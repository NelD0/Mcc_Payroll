...
<body>
  <div class="app d-flex">
    ...
    <aside class="sidebar no-print" id="sidebar">
      <a class="nav-link" href="<?php echo e(route('dashboard')); ?>"><i class="bi bi-speedometer2 me-2"></i>Dashboard</a>
      <a class="nav-link active" href="<?php echo e(route('master.list')); ?>"><i class="bi bi-list-ul me-2"></i>Master List</a>
      ...
      <nav class="nav flex-column">
        ...
        <div class="dropdown">
          ...
          <ul class="dropdown-menu w-100">
            <li><a class="dropdown-item" href="<?php echo e(route('fulltime.index')); ?>"><i class="bi bi-person-workspace me-2"></i>Instructor - Full Time</a></li>
            <li><a class="dropdown-item" href="<?php echo e(route('parttime.index')); ?>"><i class="bi bi-person-workspace me-2"></i>Instructor - Part Time</a></li>
            <li><a class="dropdown-item" href="<?php echo e(route('utility.index')); ?>"><i class="bi bi-tools me-2"></i>Utility</a></li>
            <li><a class="dropdown-item" href="<?php echo e(route('staff.index')); ?>"><i class="bi bi-people-fill me-2"></i>Staff</a></li>
          </ul>
        </div>
        ...
        <div class="dropdown">
          ...
          <ul class="dropdown-menu w-100">
            <li><a class="dropdown-item" href="<?php echo e(route('departments.index')); ?>"><i class="bi bi-gear me-2"></i>Manage Departments</a></li>
            <li><hr class="dropdown-divider"></li>
            <li><a class="dropdown-item" href="<?php echo e(route('bsit.index')); ?>"><i class="bi bi-laptop me-2"></i>BSIT</a></li>
            <li><a class="dropdown-item" href="<?php echo e(route('bsba.index')); ?>"><i class="bi bi-briefcase me-2"></i>BSBA</a></li>
            <li><a class="dropdown-item" href="<?php echo e(route('bshm.index')); ?>"><i class="bi bi-cup-hot me-2"></i>BSHM</a></li>
            <li><a class="dropdown-item" href="<?php echo e(route('education.index')); ?>"><i class="bi bi-book me-2"></i>EDUCATION</a></li>
          </ul>
        </div>
    ...
    <div class="content w-100">
      ...
      <div class="topbar d-flex align-items-center justify-content-between no-print">
        ...
        <div class="d-flex align-items-center gap-2">
          ...
          <a href="<?php echo e(url('/logout')); ?>" class="logout-icon" title="Log out">
      ...
      <div class="container-fluid py-4">
        ...
        <div class="filter-controls no-print">
          <form method="GET" action="<?php echo e(route('master.list')); ?>" class="row g-3 align-items-end">
            <div class="col-md-6">
              ...
              <select name="department" id="department" class="form-select" onchange="this.form.submit()">
                ...
                <?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dept): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <option value="<?php echo e($dept); ?>" <?php echo e($selectedDepartment === $dept ? 'selected' : ''); ?>><?php echo e($dept); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <option value="staff" <?php echo e($selectedDepartment === 'staff' ? 'selected' : ''); ?>>Staff</option>
                <option value="utility" <?php echo e($selectedDepartment === 'utility' ? 'selected' : ''); ?>>Utility</option>
              </select>
            </div>
          ...
          <div class="d-flex flex-wrap gap-2 align-items-center">
            <div class="me-auto">
              <span class="text-muted">
                ...
                Showing <?php echo e($employees->count()); ?> employee(s)
              </span>
            </div>
            
            <a href="<?php echo e(route('master.list.add')); ?>" class="btn btn-primary btn-action">
                ...
                <tr>
                  <td class="no-print">
                    <div class="form-check">
                      <input class="form-check-input employee-checkbox" type="checkbox" 
                             ...
                             data-type="<?php echo e($employee->type === 'Staff' ? 'staff' : 
                               ($employee->type === 'Utility' ? 'utility' : 
                               ($employee->type === 'Full-time Instructor' ? 'fulltime' : 'parttime'))); ?>">
                    </div>
                  </td>
                  <td>
                    <div class="employee-name"><?php echo e($employee->employee_name); ?></div>
                  </td>
                  <td>
                    <span class="employee-type <?php echo e($employee->type === 'Staff' ? 'type-staff' : 
                  ...
                  <td>
                    <?php if($employee->department): ?>
                      <span class="department-badge"><?php echo e($employee->department); ?></span>
                    <?php else: ?>
                  ...
                  <td>
                    ...
                    ?>
                    <?php echo e($rate !== null ? '₱ '.number_format((float)$rate, 2).($unit ? ' '.$unit : '') : 'N/A'); ?>
                  ...
                  <td class="no-print">
                    ...
                    <div class="btn-group btn-group-sm" role="group">
                      <a class="btn btn-outline-primary" href="<?php echo e(route($typeRoute.'.show', $employee->id)); ?>" title="View"><i class="bi bi-eye"></i></a>
                      <a class="btn btn-outline-secondary" href="<?php echo e(route($typeRoute.'.edit', $employee->id)); ?>" title="Edit"><i class="bi bi-pencil"></i></a>
                      <button type="button" class="btn btn-outline-danger" title="Delete" onclick="(function(){
                        const t='<?php echo e(strtolower($employee->type)); ?>'.includes('staff')?'staff':('<?php echo e(strtolower($employee->type)); ?>'.includes('utility')?'utility':('<?php echo e(strtolower($employee->type)); ?>'.includes('full')?'fulltime':'parttime'));
                        deleteEmployees(t==='staff'?[<?php echo e($employee->id); ?>]:[], t==='utility'?[<?php echo e($employee->id); ?>]:[], t==='fulltime'?[<?php echo e($employee->id); ?>]:[], t==='parttime'?[<?php echo e($employee->id); ?>]:[]);
                      })()">
  ...
  <script>
    ...
    async function deleteEmployees(staffIds, utilityIds, fulltimeIds, parttimeIds) {
      try {
        ...
        if (staffIds.length > 0) {
          promises.push(
            fetch('<?php echo e(route("master.list.delete")); ?>', {
              method: 'POST',
              headers: {
    ...
    async function printEmployees(staffIds, utilityIds, fulltimeIds, parttimeIds) {
      try {
        ...
        if (staffIds.length > 0) {
          promises.push(
            fetch('<?php echo e(route("master.list.print")); ?>', {
              method: 'POST',
              headers: {
                'Content-Type': 'application/json',
                'X-CSRF-TOKEN': csrfToken
    ...
    function resetFilters() {
      window.location.href = '<?php echo e(route("master.list")); ?>';
    }
...
</html><?php /**PATH C:\xampp\htdocs\Mcc_Payroll\resources\views/admin/master-list.blade.php ENDPATH**/ ?>