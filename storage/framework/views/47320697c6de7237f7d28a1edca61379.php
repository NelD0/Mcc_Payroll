  ...
  <div class="main-content">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
      ...
      <div class="d-flex align-items-center">
        ...
        <a href="<?php echo e(route('fulltime.create')); ?>" class="icon-btn add-btn" title="Add Timesheet Entry">
    ...
    function openPrintPage() {
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ...
          window.open('<?php echo e(route('fulltime.print')); ?>', '_blank');
...
<?php /**PATH C:\xampp\htdocs\Mcc_Payroll\resources\views/fulltime/index.blade.php ENDPATH**/ ?>