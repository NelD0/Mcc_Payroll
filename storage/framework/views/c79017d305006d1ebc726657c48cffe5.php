...
<head>
  <meta charset="UTF-8">
  <title>Add Part-time Timesheet</title>
  <!-- Bootstrap 5 CSS -->
...
<body>
  <div class="main-content">
    ...
    <form action="<?php echo e(route('parttime.store')); ?>" method="POST">
      <?php echo csrf_field(); ?>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="mb-3">
            ...
            <input type="number" step="0.01" class="form-control" id="rate_per_hour" name="rate_per_hour" value="120.00">
          </div>
        </div>
      </div>
      ...
      <div class="button-group">
        ...
        <a href="<?php echo e(route('parttime.index')); ?>" class="btn btn-secondary">
...
</html><?php /**PATH C:\xampp\htdocs\Mcc_Payroll\resources\views/parttime/create.blade.php ENDPATH**/ ?>