...
<body>
  <div class="main-content">
    ...
    <form action="<?php echo e(route('utility.store')); ?>" method="POST">
      <?php echo csrf_field(); ?>
            ...
            <?php for($i = 1; $i <= 15; $i++): ?>
              <div class="col-md-3 col-sm-4 col-6 mb-2">
                <div class="form-check">
                  <input class="form-check-input day-checkbox" type="checkbox" value="<?php echo e($i); ?>" id="day<?php echo e($i); ?>">
      ...
      <div class="button-group">
        ...
        <a href="<?php echo e(route('utility.index')); ?>" class="btn btn-secondary">
...
</html><?php /**PATH C:\xampp\htdocs\Mcc_Payroll\resources\views/utility/create.blade.php ENDPATH**/ ?>