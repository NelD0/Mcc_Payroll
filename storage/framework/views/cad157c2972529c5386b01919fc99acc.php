...
<body>
    <div class="login-container">
        ...
        <div class="attendance-badge">
            <i class="fas fa-clipboard-check"></i> ATTENDANCE CHECKER
        </div>
        <h2>Attendance Access</h2>
        <form id="attendanceLoginForm" action="<?php echo e(route('attendance.login')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <input type="hidden" name="user_type" value="attendance">
            <div class="input-group">
                <label for="email">Checker Email</label>
                <input type="email" id="email" name="email" placeholder="Enter checker email" required>
            </div>
            <div class="input-group">
                <label for="password">Checker Password</label>
                <input type="password" id="password" name="password" placeholder="Enter checker password" required>
            </div>
            <button type="submit">
    ...
    <script>
        ...
        document.getElementById('attendanceLoginForm')?.addEventListener('submit', function(e) {
            ...
            Swal.fire({
                title: 'Verifying Checker Access...',
                text: 'Please wait while we verify your attendance checker credentials.',
...
</html><?php /**PATH C:\xampp\htdocs\Mcc_Payroll\resources\views/attendance/login.blade.php ENDPATH**/ ?>