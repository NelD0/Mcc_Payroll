  ...
  <div class="main-content">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
      <div class="d-flex align-items-center">
        <a href="<?php echo e(route('dashboard')); ?>" class="icon-btn btn-back me-3" title="Back to Dashboard">
      ...
      <div class="d-flex align-items-center">
        ...
        <a href="<?php echo e(route('parttime.create')); ?>" class="icon-btn add-btn" title="Add Timesheet Entry">
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td id="total-hour-<?php echo e($timesheet->id); ?>"><?php echo e($timesheet->total_hour); ?></td>
            <td>
              <input type="number" 
                     class="form-control field-input" 
                     value="<?php echo e($timesheet->rate_per_hour); ?>" 
                     data-timesheet-id="<?php echo e($timesheet->id); ?>" 
            ...
            <td>
              <input type="number" 
                     class="form-control field-input" 
                     value="<?php echo e($timesheet->deduction); ?>" 
                     data-timesheet-id="<?php echo e($timesheet->id); ?>" 
            ...
            <td id="total-honorarium-<?php echo e($timesheet->id); ?>">₱<?php echo e(number_format($timesheet->total_honorarium, 2)); ?></td>
    ...
    <div class="print-footer" style="display: none;">
      <p>Generated by MCC Payroll System - <?php echo e(date('Y-m-d H:i:s')); ?></p>
    </div>
  </div>
    ...
    function openPrintPage() {
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ...
          window.open('<?php echo e(route('parttime.print')); ?>', '_blank');
...
</html><?php /**PATH C:\xampp\htdocs\Mcc_Payroll\resources\views/parttime/index.blade.php ENDPATH**/ ?>