...
<body>
  <div class="app d-flex">
    ...
    <aside class="sidebar" id="sidebar">
      <a href="<?php echo e(route('admin.dashboard')); ?>" class="nav-link"><i class="bi bi-speedometer2 me-2"></i>Dashboard</a>
      ...
      <nav class="nav flex-column">
        ...
        <a href="<?php echo e(route('salary.adjustment')); ?>" class="sidebar-btn text-decoration-none active" style="background: #fff; color: var(--brand-600);"><i class="bi bi-calculator me-2"></i>Salary Adjustment/Differential</a>
      </nav>
    </aside>
      ...
      <div class="container-fluid py-4">
        <div class="card-soft p-4">
          ...
          <div class="college-header">
            <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Logo" style="height:80px;" onerror="this.style.display='none'"><br>
...
</html><?php /**PATH C:\xampp\htdocs\Mcc_Payroll\resources\views/salary/adjustment.blade.php ENDPATH**/ ?>