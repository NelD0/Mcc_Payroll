...
<body>
    <div class="container">
        ...
        <?php endif; ?>
        <form action="<?php echo e(route('attendance.forgot.send')); ?>" method="POST">
            <?php echo csrf_field(); ?>
        ...
        <div class="link">
            <a href="<?php echo e(route('attendance.attendlog.form')); ?>">Back to Attendance Login</a>
        </div>
    </div>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
</body>
</html><?php /**PATH C:\xampp\htdocs\Mcc_Payroll\resources\views/attendance/forgot_password.blade.php ENDPATH**/ ?>