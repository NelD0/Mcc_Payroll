...
<head>
    ...
    <style>
        body {
            ...
            background: linear-gradient(rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.4)), url('<?php echo e(asset('images/mcc.jpg')); ?>');
...
<body>
    <div class="container">
        ...
        <p class="footer-text">
            Need access? <a href="<?php echo e(url('/register')); ?>">Create New Account</a> | Contact Administrator
        </p>
    </div>
...
</html><?php /**PATH C:\xampp\htdocs\Mcc_Payroll\resources\views/index.blade.php ENDPATH**/ ?>