...
<body>
    <div class="header">
        ...
        <div class="user-info">
            <div class="user-badge">
                <i class="fas fa-user"></i> <?php echo e(session('user_name')); ?>

                <?php if(session('user_course')): ?>
                    <span class="course-badge"><?php echo e(strtoupper(session('user_course'))); ?></span>
                <?php endif; ?>
            </div>
            <a href="<?php echo e(url('/logout')); ?>" class="logout-btn">
    ...
    <div class="container">
        ...
        <div class="card">
            ...
            <h3><i class="<?php echo e($currentCourse['icon']); ?>"></i> <?php echo e($currentCourse['name']); ?></h3>
            <p><?php echo e($currentCourse['description']); ?></p>
            <div class="course-selection">
                <div class="single-course-grid">
                    <div class="course-card" onclick="loadAttendance('<?php echo e(strtolower($userCourse)); ?>')">
                        <div class="course-icon <?php echo e($currentCourse['color']); ?>">
                            <i class="<?php echo e($currentCourse['icon']); ?>"></i>
                        </div>
                        <h4><?php echo e($userCourse); ?> Attendance</h4>
                        <p><?php echo e($currentCourse['name']); ?></p>
...
</html><?php /**PATH C:\xampp\htdocs\Mcc_Payroll\resources\views/attendance/dashboard.blade.php ENDPATH**/ ?>