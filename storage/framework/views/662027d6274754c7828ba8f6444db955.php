...
<head>
    ...
    <style>
        body { font-family: Arial, sans-serif; height: 100vh; margin: 0; display: flex; justify-content: center; align-items: center; background: linear-gradient(rgba(52, 152, 219, 0.3), rgba(0, 0, 0, 0.4)), url('<?php echo e(asset('images/mcc.jpg')); ?>'); background-size: cover; background-position: center; }
...
<body>
    <div class="container">
        ...
        <?php if(session('error')): ?>
            <div style="color:#c0392b; margin-bottom:8px;"><?php echo e(session('error')); ?></div>
        <?php endif; ?>
        <?php if(session('success')): ?>
            <div style="color:#27ae60; margin-bottom:8px;"><?php echo e(session('success')); ?></div>
        <?php endif; ?>
        <form action="<?php echo e(route('attendance.reset.submit')); ?>" method="POST">
            <?php echo csrf_field(); ?>
        ...
        <div class="link">
            <a href="<?php echo e(route('attendance.forgot.form')); ?>">Resend OTP</a> ·
            <a href="<?php echo e(route('attendance.attendlog.form')); ?>">Back to Login</a>
        </div>
    </div>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
</body>
</html><?php /**PATH C:\xampp\htdocs\Mcc_Payroll\resources\views/attendance/reset_password.blade.php ENDPATH**/ ?>