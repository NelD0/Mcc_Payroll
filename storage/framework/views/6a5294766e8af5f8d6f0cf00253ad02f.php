...
<body>
    <div class="card">
        <div class="header">
            <img class="logo" src="<?php echo e(asset('images/logo.png')); ?>" alt="MCC Payroll Logo">
        </div>
...
</html><?php /**PATH C:\xampp\htdocs\Mcc_Payroll\resources\views/emails/attendance_otp.blade.php ENDPATH**/ ?>