...
<body>
  ...
  <div class="main-content">
    ...
    <div class="float-end">
      ...
      <a href="{{ route('utility.create') }}" class="icon-btn add-btn" title="Add Timesheet Entry">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="actions-column">
              ...
              <form action="{{ route('utility.destroy', $timesheet->id) }}" method="POST" style="display:inline;">
                @csrf
                @method('DELETE')
    ...
    function openPrintPage() {
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ...
          window.open('{{ route('utility.print') }}', '_blank');
