...
<head>
  <meta charset="UTF-8">
  <title>BSHM Attendance Checker</title>
  <!-- Bootstrap 5 CSS -->
  ...
  <style>
    body {
      ...
      margin: 0;
      padding: 0;
      background: #dc3545; /* Red background for BSHM */
      min-height: 100vh;
      display: flex;
    ...
    table thead {
      background-color: #f8d7da; /* Light red header for BSHM */
    }
        ...
        <tbody>
          ...
          <tr>
            <td colspan="11" class="text-center text-muted py-4">
              <i class="bi bi-inbox me-2"></i>No BSHM attendance records found
            </td>
          </tr>
          @endforelse
        </tbody>
