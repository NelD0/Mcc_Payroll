...
<body>
    <div class="login-container">
        ...
        <form id="attendance-login-form" action="{{ route('attendance.attendlog') }}" method="POST">
            ...
            <p class="back-link">
                <a href="{{ url('/') }}"><i class="fas fa-arrow-left"></i> Back to Main Login</a>
            </p>
        </form>
    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const lockoutRemaining = @json(session('lockout_remaining', 0));
            const attemptsLeft = @json(session('attempts_left'));
