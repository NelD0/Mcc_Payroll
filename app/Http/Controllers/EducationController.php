...
class EducationController extends Controller
{
    ...
    {
        // Fetch only EDUCATION department timesheets
        $fulltimeTimesheets = FulltimeTimesheet::where('department', 'EDUCATION')->get();
        $parttimeTimesheets = ParttimeTimesheet::where('department', 'EDUCATION')->get();
        ...
        return view('education.index', compact('attendanceRecords'));
    }
